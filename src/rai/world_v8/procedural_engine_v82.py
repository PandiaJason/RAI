"""
====================================================================================================
🌌 RAI v8.2 PROCEDURAL WORLD ENGINE WITH PARAMETRIC REWARD ABLATION
====================================================================================================
Supports controlled reward formulation modes:
  - 'asymmetric': Current double downside penalty (Reward = 5.0 * r - 2.0 * max(0,-r) + 2.0 * DD)
  - 'symmetric_log': Pure Log-Growth (Reward = log(W_t / W_{t-1}) - 0.001 * Turnover)
  - 'log_moderate_risk': Log-Growth + Moderate Downside Variance (Reward = log(W_t / W_{t-1}) - 0.5 * max(0,-r)^2)
====================================================================================================
"""
...
class ProceduralWorldEngineV82:
    ...
    def step(self, action):
        ...
        # PARAMETRIC REWARD MODES
        if self.reward_mode == 'asymmetric':
            # Arm A: Current Asymmetric Penalties
            ...
            # Arm B: Pure Symmetric Log-Growth
            ...
            # Arm C: Log-Growth + Moderate Downside Variance
            log_growth = np.log(new_wealth / max(1e-4, self.last_wealth))
