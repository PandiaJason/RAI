...
class SyntheticLinkPredictionDataset(InMemoryDataset):
    def __init__(self, root, families=['A', 'B', 'C'], num_graphs=1000, min_entities=10, max_entities=50, transform=None, pre_transform=None):
    ...
    def processed_file_names(self):
        f_str = "".join(sorted(self.families))
        return [f'data_{f_str}_{self.num_graphs}_{self.min_entities}_{self.max_entities}.pt']
    ...
    def process(self):
        ...
        for i in range(self.num_graphs):
            ...
            all_edges = HiddenLawGenerator.generate(family, num_e, target_edges)
